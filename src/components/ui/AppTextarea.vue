...
<template>
  <div class="w-full">
    ...
    <textarea
      ...
      :class="[
        'w-full resize-y rounded-lg border bg-surface px-3.5 py-2.5 text-[15px] text-fg outline-none',
        ...
        error ? 'border-danger focus:ring-danger/20' : 'border-border-strong',
      ]"
    />
